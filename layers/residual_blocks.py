...
def preact_resnet_group(block_func, in_channels, base_channels, num_blocks,
                        stride=1, dilation_rate=1):
    ...
    residual_blocks = [
        block_func(in_channels, base_channels, stride=stride, dilation_rate=dilation_rate, add_preact=False)]
    in_channels = block_func.expansion() * base_channels
    for idx in range(1, num_blocks):
        residual_blocks.append(
            block_func(in_channels, base_channels, dilation_rate=dilation_rate, add_preact=True,
