...
def hdc_resnet_group(block_func, in_channels, base_channels, num_blocks,
                     dilation_rates):
    ...
    residual_blocks = [block_func(in_channels, base_channels, dilation_rate=dilation_rates[0], add_preact=False)]
    in_channels = block_func.expansion() * base_channels
    for idx in range(1, num_blocks):
        residual_blocks.append(
            block_func(in_channels, base_channels, dilation_rate=dilation_rates[idx % num_rates], add_preact=True,
